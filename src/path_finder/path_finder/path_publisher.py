    ...
    def RRT(img, img2, start, end, stepSize):
        ...
        while pathFound==False:
            ...
            if directCon and nodeCon:
                ...
                np.save("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/found_path.npy",path_found)
                # cv2.waitKey(1)
                #cv2.imwrite("media/"+str(i)+".jpg",img2)
                cv2.imwrite("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/out.jpg",img2)
                break
...
def mapping(image_path):
    ...
    """
    calib_points=np.load("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/calib_coordinates.npy")
    ...
    cv2.imwrite("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/try.jpg",image_new)
    x=cv2.imread("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/try.jpg")
    ...
    for r in range(864):
        for c in range(648):
            if y[c,r]>=1:
                ...
                imgfin[c,r,0]=255
                imgfin[c,r,2]=255
    cv2.imwrite("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/map.jpg",y)
    cv2.imwrite("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/generatedmap.jpg",imgfin)
    #cv2.waitKey(0)
class PathPublisher(Node):
    ...
    def timer_callback(self):
    	try:
            msg = String()
            img_path="/home/ayberk/nemo_ws/src/path_finder/temp_workspace/image.jpg"
            calibration=False
            dest=np.load("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/target_coordinates.npy")
            xfin=dest[0]
            yfin=dest[1]
    ...
    # loop over the detected ArUCo corners
            ...
            # convert each of the (x, y)-coordinate pairs to integers
                    ...
                    cv2.imwrite("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/image2.jpg",image)
            ...
            if abs(cX-xfin)>5 and abs(cY-yfin)>5:
                try:
                    ...
                    print("Dir already clean")
                mapping("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/image2.jpg")
                RRT_call(xstart,ystart,xfin,yfin,"/home/ayberk/nemo_ws/src/path_finder/temp_workspace/map.jpg")
                path=np.load("/home/ayberk/nemo_ws/src/path_finder/temp_workspace/found_path.npy")
